...
* **ชื่อเต็ม**: ธาร์ (Thar)
* **ฉายา**: แพทย์แห่งหายนะ (The Physician of Calamity) / คุณหมอแว่น (โดยโดเรีย)
...
* **ภาพการออกแบบตัวละคร**: [Tar_base_Desgin.png](file:///d:/Dorea%20Pricese%20Journey/Story%20Section/Assets/Images/Tar_base_Desgin.png) (สามารถดูรายละเอียดเพิ่มเติมได้ที่ [แนวคิดการออกแบบตัวละคร](file:///d:/Dorea%20Pricese%20Journey/Story%20Section/Characters/Design_Focus.md))
...
* **สไตล์การแต่งตัว**:
  ...
  * สวมแว่นตากรอบกลมบางสีเงิน (กรอบเก่าเคยหัก และโดเรียซื้ออันใหม่เลนส์ตัดแสงมานา 100% กรอบไทเทเนียมผสมมิธริลระดับพรีเมียมให้เป็นของขวัญ)
...
* **รอยแผลเป็น**:
  * มีรอยแผลเป็นจางๆ ที่แก้มซ้าย (ฝีมือโดเรียข่วนตอนพบกันครั้งแรกท่ามกลางฝนตก)
  * มีรอยแผลเป็นที่ลาดไหล่ซ้าย (เกิดจากการที่โดเรียจิกยึดไหล่และแขนซ้ายของเขาแน่นยามระแวงและจับไข้ละเมอ)
...
* **กับโดเรีย (Co-dependency & Care)**:
  * เป็นพี่ชายและคู่ชีวิตที่ตามใจและเข้าใจความเจ็บปวดของโดเรียมากที่สุด ยอมเจ็บตัวเพื่อปกป้องและรักษาจิตใจที่แตกสลายของเธอ แผ่ไออุ่นดูแลเธอ
  * รักษาขอบเขตอันเหมาะสม ใช้ถ้อยคำสุภาพปลอบใจ "ไม่เป็นไรแล้วนะครับ... ไม่เป็นไรแล้ว... ปลอดภัยแล้วนะครับ..." โดยตัดคำว่า "เด็กดี" ออกเพื่อความสุขุมระดับผู้ใหญ่
  * ยอมรับพฤติกรรมอ้อน คลอเคลีย และการแสดงความเป็นเจ้าของของโดเรียอย่างเต็มใจ แม้บางครั้งจะเขินอายจนต้องแก้เก้อด้วยการจับแว่นหรือหันไปจัดอุปกรณ์การแพทย์ข่มใจ
...
* **Anatomical Suture & Mana Infused Surgeon (หัตถการเวชและเข็มมานา)**: ฝีมือการทำแผลและผ่าตัดด้วยสมาธิขั้นสูง ธาร์ลำเลียงกระแสมานาสลักลงบนเครื่องมือแพทย์ เสริมความแข็งแกร่งให้เข็มเย็บแผลจนสามารถแทงทะลวงผ่านเกล็ดผิวของดราโกนอยด์ที่หนาเป็นพิเศษของโดเรียได้อย่างแม่นยำและราบรื่น ไร้การสะดุด
* **Mana Core Dissection (หัตถการชำแหละแกนมานา - Signature Move)**:
  * วิชาต้องห้ามระดับสูงสุดที่ประยุกต์จากความรู้ด้านกายวิภาคและจุดตายของกระแสมานา เป็นการส่งเข็มมานาเจาะทะลวงจุดศูนย์กลางพลังงานของเป้าหมายอย่างแม่นยำเพื่อตัดขาดการไหลเวียน ทำให้ระบบพลังงานล้มเหลวเฉียบพลันและร่างกายช็อกหมดสติโดยไร้บาดแผลภายนอก เป็นวิชาอันตรายที่ธาร์จะยอมใช้เฉพาะเมื่อต้องการปกป้องโดเรียเท่านั้น (เปลี่ยนจากการระเบิดฟิสิกส์เป็นการโจมตีจุดตายแบบศัลยแพทย์)
...
* **วัย 10 ปี**: สูญเสียหมู่บ้านและพ่อแม่ (ช่างไม้และช่างเย็บผ้า) ไปในกองเพลิงสงคราม นั่งเหม่อกอดกุมท่อนแขนไร้ชีพของพ่อแม่จมเถ้าถ่านขี้เถ้าดินโคลนอย่างไร้น้ำตาแต่ดวงตาสิ้นหวัง (Shared Trauma ขนานกับโดเรีย) ปู่กิเดียนมาพบและกอดดึงจิตใจขึ้นมา ชุบเลี้ยงในบ้านริมชายแดนท้ายหมู่บ้านกรีนวัลเลย์
...
* **วัย 15 ปี**: พบโดเรียนอนคว่ำหน้าบาดเจ็บในคืนฝนตก ทนเจ็บยอมโดนข่วนแก้มซ้ายและจิกไหล่ซ้ายเพื่อกอดรัดปลอบประโลมจิตใจเธออย่างนุ่มนวลและสุภาพ แบกเธอที่ตัวหนักแน่นดั่งหินผาขึ้นหลังอย่างทุลักทุเลฝ่าพายุกลับบ้าน ทำแผลเย็บแผลกว่า 30 ฝีเข็มบนเกล็ดหนาของดราโกนอยด์
* **วัย 15-20 ปี**: ดูแลประคับประคองโดเรีย สอนวิชาความรู้และการผ่อนน้ำหนักแรงให้ เรียนรู้อาการป่วยของปู่กิเดียน ตั้งเป้าหมายชิงทุนเข้ามหาวิทยาลัยเพื่อหายารักษาปู่กิเดียน
