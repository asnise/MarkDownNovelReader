# ข้อมูลตัวละคร: โดเรีย (Dorea / Doria)

* **ชื่อเต็ม**: เลดี้โดเรียแห่งตระกูล ไวร์ชีล (Lady Dorea / Doria of Wyvernshield) หรือ เจ้าหญิงโดเรีย (Princess Dorea)
...
* **ภาพการออกแบบตัวละคร**: [Dorea_base_Desgin.jpg](file:///d:/Dorea%20Pricese%20Journey/Story%20Section/Assets/Images/Dorea_base_Desgin.jpg) (สามารถดูรายละเอียดเพิ่มเติมได้ที่ [แนวคิดการออกแบบตัวละคร](file:///d:/Dorea%20Pricese%20Journey/Story%20Section/Characters/Design_Focus.md))
...
* **กับธาร์ (Co-dependency & Devotion)**:
  ...
  * ว่านอนสอนง่ายและพยายามผ่อนแรงควบคุมพละกำลังตามที่ธาร์คอยสั่งสอน

---

## 3. ความสามารถและสไตล์การต่อสู้ (Abilities & Combat Style)

* **Mana Body Reinforcement (การเสริมแกร่งด้วยมานา)**: พละกำลังระดับปีศาจของเธอไม่ได้มาจากแค่ค่าพลังกล้ามเนื้อ แต่มาจากการควบคุม "แก่นมานา" ภายในให้ไหลเวียนเสริมสมรรถภาพร่างกาย ในยามปกติโดเรียสามารถกะแรงหยิบจับสิ่งของได้เหมือนคนปกติ แต่เมื่ออารมณ์ไม่คงที่ (เช่น Panic, ฝันร้าย, หวาดระแวง) มานาในร่างจะแปรปรวนและล้นทะลักเสริมพลังให้ร่างกายโดยอัตโนมัติ ทำให้เธอเผลอทำลายของหรือทำร้ายผู้คน (เช่น ธาร์ในตอนที่เธอละเมอ) โดยไม่ได้ตั้งใจ
* **สไตล์การต่อสู้ (Hand-to-Hand Combat)**: แตกต่างจากนักรบดราโกนอยด์ทั่วไปที่มักใช้ "หอก" เป็นอาวุธ โดเรียเข้าใจศาสตร์การใช้อาวุธดี แต่เธอเลือกที่จะ **ไม่ใช้อาวุธตายตัว** สไตล์หลักของเธอคือการต่อสู้ระยะประชิด ใช้ความเร็ว หมัด กรงเล็บ หรือมือเปล่าในการตวัด ต่อย และบดขยี้ศัตรูโดยตรง
* **Original Magic & Body Alteration (เวทมนตร์และการแปรสภาพ)**: โดเรียไม่เน้นการยิงเวทมนตร์เป็นลำแสง แต่เน้นใช้เวทมนตร์ออริจินัลเพื่อ **แปรสภาพภูมิประเทศ** หรือ **แปรสภาพร่างกายตนเอง** (เช่น การควบคุมเส้นผมสีเงินให้ขยับพริ้วไหวและแข็งแกร่งดุจเหล็กกล้าเพื่อเสริมการโจมตีหรือป้องกันได้อย่างอิสระ)
* **Dragon Transformation**:
  * **Partial (บางส่วน)**: งอกกรงเล็บแหลมคมและเกล็ดมังกรตามแขนขาเพื่อรับแรงปะทะและเพิ่มพลังทำลาย
  * **Demi-Dragon (ร่างกึ่งมังกร)**: ร่างต่อสู้ขั้นสูงที่จะเพิ่มสมรรถภาพและขีดจำกัดทางร่างกายขึ้นไปอีกขั้น ร่างกายจะขยายมวลกล้ามเนื้อและส่วนสูง หางและเขาใหญ่ขึ้น ถูกปกคลุมด้วยเกล็ดสีดำทมิฬและมีลวดลายเส้นแสงสีทองแบบ **Abstract Geometric Lines** เคลื่อนไหวไปมาทั่วร่างเพื่อรักษาโมเลกุลไม่ให้สลายตัวกลายเป็นมังกรไร้สติ
...
* **วัย 5 ปี**: เกิดปี D.S. 793 แสดงออกชัดเจนว่าเกลียดอากาศเย็นและลมหนาวเด่นชัด ต่อรองขอแก้ซับในกระโปรงยาวในงานเลี้ยง และแอบหลบหนีไปกินเนื้อย่างราดซอสเผ็ดร้อนหลังครัวเพื่อรับความอุ่น ไปโรงเรียนหลวงวันแรก เรียนเก่งหัวไววิเคราะห์อักขระเวทเด่นชัด ยกโต๊ะไม้หนาเพื่อเก็บของเล่นให้ฟลอร่าจนเพื่อน ๆ ตาค้าง เซฟิรัสเผลอปล่อยเวทลมพัดกระโปรงทำให้โดเรียอายจนหางรัดโคนขาแน่น ช่วยคนสวนถอนวัชพืชดึงต้นไม้หายากหลุดติดรากดินก้อนยักษ์
...
* **วัย 13 ปี (จุดเปลี่ยน - วันที่ท้องฟ้าล่ม)**: อาณาจักรลอยฟ้าดราโกเนียถูกเอเธลการ์ดบุก แม่นมเซลีนโดนฉมวกยักษ์เสียบตรึงเสียชีวิตต่อหน้าต่อตา ต้องตัดใจทิ้งร่างพี่ลิซ่าที่จมกองเลือดหนีภัย ท่านหญิงเอนย่าเอาตัวเข้าบังกระสุนฉมวกยักษ์แทนโดเรียจนแขนซ้ายสีเงินขาดสะบั้น เอนย่าปักดาบเปิดวงเวทส่งโดเรียข้ามมิติหนีไป โดเรียร้องไห้กอดแขนซ้ายมารดาที่ขาดแนบอกข้ามมิติมา
